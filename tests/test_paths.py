...
def test_relpath():
    assert generate_diff(render, 'fixtures/1.json', 'fixtures/2.json') == "Property 'timeout' was removed"
...
def test_abs_and_rel_path():
    assert generate_diff(render, 'fixtures/2.json', os.path.abspath('fixtures/1.json')
    ) == "Property 'timeout' was added with value: '50'"
